...
namespace ShoesShop
{
    public partial class FormProducts : Form
    {
        ...
        public FormProducts(User user, bool guest)
        {
            ...
            var colDiscound = new DataGridViewTextBoxColumn();
            colDiscound.Name = "colDiscount";
            colDiscound.FillWeight = 10;
            colDiscound.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            dgvProducts.Columns.AddRange(
            [
                colPhoto, colInfo, colDiscound
            ]);
